...
public class TeleportUtil extends Teleporter {
    ...
    public void placeInPortal(Entity entity, float rotationYaw) {
        ...
        y = world.getTopSolidOrLiquidBlock(new BlockPos(x, y, z)).getY();
    ...
    public static void teleportToDimension(EntityPlayer player, int dimension, double x, double y, double z) {
        ...
        if(oldDimension != dimension) worldServer.getMinecraftServer().getPlayerList().transferPlayerToDimension(entityPlayerMP, dimension, new TeleportUtil(worldServer, x, y, z));
